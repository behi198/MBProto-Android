package com.blackshadowsgroup.mbproto.encryption.encrypt.preferences;

/**
 * Created by Behi198 on 6/17/2017.
 */
...
public class MySharedPreferences {
    ...
    public static MySharedPreferences getInstance(Context contxt, String prefName) {
        if (instance == null) {
            byte[] key = new byte[]{18, 11, 25, 92, 87,
                    25, 115, 65, 72, 98,
                    88, 54, 126, 115, 122,
                    88, 7, 3, 65, 25,
                    -11, -18, -85, 43, -8,
    ...
    public long getLong(String key, long value)
        ...
        if (preferences.contains(toKey(key))) {
            String securedEncodedValue = preferences.getString(toKey(key), "");
            String decrypted = decrypt(securedEncodedValue);
            if (decrypted.equals(""))
                return 2;
            else
